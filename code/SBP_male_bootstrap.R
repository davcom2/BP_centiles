...
doc <- docx( )%>%
  addTitle("Male SBP centiles with 95% CI") %>%
  addFlexTable(table %>%
...
writeDoc(doc, file = "SBP_male_ci_091018.docx")

sbp_m_table <- table
save(sbp_m_table,file="C:/Users/sgerry/Dropbox/Steve work/VM/Precursor/SBP_m_table.RData")
