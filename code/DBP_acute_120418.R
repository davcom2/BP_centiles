...
DBP_m_em_FP1 <- gamlss(DBP ~ fp( age, 3), sigma.fo=~ fp( age, 3),family=ST3,data=dat,n.cyc=200)

mat1 <- centiles.pred(DBP_m_em_FP1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat1t <- centiles.pred(DBP_m_em_FP1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
DBP_f_em_FP1 <- gamlss(DBP ~ fp( age, 3), sigma.fo=~ fp( age, 3),family=SEP3,data=dat,n.cyc=200)

mat2 <- centiles.pred(DBP_f_em_FP1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat2t <- centiles.pred(DBP_f_em_FP1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))


myvars <- c("age", "DBP")
newdata <- male_elective[myvars]
dat<-na.omit(newdata)
dat<-dat[(dat$age>=18 & dat$age<90),]

DBP_m_el_FP1 <- gamlss(DBP ~ fp( age, 3), sigma.fo=~ fp( age, 3),family=SEP3,data=dat,n.cyc=200)

mat3 <- centiles.pred(DBP_m_el_FP1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat3t <- centiles.pred(DBP_m_el_FP1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
DBP_f_el_FP1 <- gamlss(DBP ~ fp( age, 3), sigma.fo=~ fp( age, 3),family=SEP3,data=dat,n.cyc=200)

mat4 <- centiles.pred(DBP_f_el_FP1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat4t <- centiles.pred(DBP_f_el_FP1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
g <- g + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  ...
  theme(legend.position="none") + ylab("Diastolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Male Emergency")
...
g1 <- g1 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(40,60,80,100,120), limits=c(40,120)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Diastolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Female Emergency")
...
g2 <- g2 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(40,60,80,100,120), limits=c(40,120)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Diastolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Male Elective")
...
g3 <- g3 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(40,60,80,100,120), limits=c(40,120)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Diastolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Female Elective")
...
writeDoc(doc, file = "DBP_acute_091018_100_FP.docx")
