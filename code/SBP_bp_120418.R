...
SBP_m_n_BCTo1 <- lms(SBP, age, data=dat,trans.x=TRUE, families=c("BCTo"), n.cyc=100)

mat1 <- centiles.pred(SBP_m_n_BCTo1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat1t <- centiles.pred(SBP_m_n_BCTo1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
SBP_f_n_BCTo1 <- lms(SBP, age, data=dat,trans.x=TRUE, families=c("BCTo"), n.cyc=100)

mat2 <- centiles.pred(SBP_f_n_BCTo1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat2t <- centiles.pred(SBP_f_n_BCTo1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
SBP_m_b_BCTo1 <- lms(SBP, age, data=dat,trans.x=TRUE, families=c("BCTo"), n.cyc=100)

mat3 <- centiles.pred(SBP_m_b_BCTo1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat3t <- centiles.pred(SBP_m_b_BCTo1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
SBP_f_b_BCTo1 <- lms(SBP, age, data=dat,trans.x=TRUE, families=c("BCTo"), n.cyc=100)

mat4 <- centiles.pred(SBP_f_b_BCTo1, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat4t <- centiles.pred(SBP_f_b_BCTo1, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
g <- g + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  ...
  theme(legend.position="none") + ylab("Systolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Male Without BP Medication")
...
g1 <- g1 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(80,100,120,140,160,180,200), limits=c(80,210)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Systolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Female Without BP Medication")
...
g2 <- g2 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(80,100,120,140,160,180,200), limits=c(80,210)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Systolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Male With BP Medication")
...
g3 <- g3 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(80,100,120,140,160,180,200), limits=c(80,210)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Systolic Blood Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Female With BP Medication")
...
writeDoc(doc, file = "SBP_bp_091018_100.docx")
...
empirical10<-ddply(dat, "year", here(summarise), P = quantile(SBP, .1))
empirical25<-ddply(dat, "year", here(summarise), P = quantile(SBP, .25))
empirical50<-ddply(dat, "year", here(summarise), P = quantile(SBP, .5))
empirical75<-ddply(dat, "year", here(summarise), P = quantile(SBP, .75))
empirical90<-ddply(dat, "year", here(summarise), P = quantile(SBP, .9))
