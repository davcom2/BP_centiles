...
doc <- docx( )%>%
  addTitle("Male PP centiles with 95% CI") %>%
  addFlexTable(table %>%
  ...
  writeDoc(doc, file = "PP_male_ci_111018.docx")

pp_m_table <- table
save(pp_m_table,file="C:/Users/sgerry/Dropbox/Steve work/VM/Precursor/PP_m_table.RData")
