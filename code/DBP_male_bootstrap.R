...
doc <- docx( )%>%
  addTitle("Male DBP centiles with 95% CI") %>%
  addFlexTable(table %>%
  ...
  writeDoc(doc, file = "DBP_male_ci_111018.docx")

dbp_m_table <- table
save(dbp_m_table,file="C:/Users/sgerry/Dropbox/Steve work/VM/Precursor/DBP_m_table.RData")
