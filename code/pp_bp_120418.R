...
pp_m_n_ST31 <- lms(pp, age, data=dat,trans.x=TRUE, families=c("ST3"), n.cyc=100)

mat1 <- centiles.pred(pp_m_n_ST31, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat1t <- centiles.pred(pp_m_n_ST31, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
pp_f_n_ST31 <- lms(pp, age, data=dat,trans.x=TRUE, families=c("ST3"), n.cyc=100)

mat2 <- centiles.pred(pp_f_n_ST31, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat2t <- centiles.pred(pp_f_n_ST31, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
pp_m_b_ST31 <- lms(pp, age, data=dat,trans.x=TRUE, families=c("ST3"), n.cyc=100)

mat3 <- centiles.pred(pp_m_b_ST31, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat3t <- centiles.pred(pp_m_b_ST31, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
pp_f_b_ST31 <- lms(pp, age, data=dat,trans.x=TRUE, families=c("ST3"), n.cyc=100)

mat4 <- centiles.pred(pp_f_b_ST31, xname="age",xvalues=seq(18,90,0.1), plot=TRUE, cent=seq(1,99,1), legend=F, xlab="Age (years)", ylab="Systolic Blood Pressure (mmHg)" )
mat4t <- centiles.pred(pp_f_b_ST31, xname="age",xvalues=seq(20,90,2), plot=F, cent=c(1,5,10,25,50,75,90,95,99))
...
g <- g + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(20,40,60,80,100,120,140,140), limits=c(20,140)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Pulse Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Male Without BP Medication")
...
g1 <- g1 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(20,40,60,80,100,120,140,140), limits=c(20,140)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Pulse Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Female Without BP Medication")
...
g2 <- g2 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(20,40,60,80,100,120,140,140), limits=c(20,140)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Pulse Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Male With BP Medication")
...
g3 <- g3 + theme_bw() + scale_x_continuous(breaks = seq(20,90,10), limits=c(20,90)) + 
  scale_y_continuous(breaks = c(20,40,60,80,100,120,140,140), limits=c(20,140)) + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + 
  theme(legend.position="none") + ylab("Pulse Pressure (mmHg)") + xlab("Age (years)") + ggtitle("Female With BP Medication")
...
writeDoc(doc, file = "pp_bp_091018_100.docx")
